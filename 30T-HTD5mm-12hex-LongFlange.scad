...
hexagon_size = 12.8;        //  1/2" use 12.9
//hexagon_size = 9.6;        //  3/8" use 9.6

motor_shaft = 12.7;	// NEMA17 motor shaft exact diameter = 5
...
retainer_wd = 1.5 ;	// height of retainer flange over pulley, standard = 1.5
retainer_ht = 3 ;	// height of retainer flange over pulley, standard = 1.5
idler = 1;			// Belt retainer below teeth, 0 = No, 1 = Yes
idler_wd = 1.5;		// height of idler flange over pulley, standard = 1.5
...
//		polygon([[0,0],[pulley_OD/2,0],[pulley_OD/2 + retainer_ht , retainer_ht],[0 , //retainer_ht],[0,0]]);}
    ...
    if ( retainer > 0 ) {
		...
		polygon([
        [0,0]
        ,[pulley_OD/2 + retainer_ht,0]
        ,[pulley_OD/2 + retainer_ht , retainer_wd]
        ,[0 , retainer_wd]
        ,[0,0]]);}
